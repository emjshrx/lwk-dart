...
class LwkCoreApiImpl extends LwkCoreApiImplPlatform implements LwkCoreApi {
  ...
  Future<PayjoinTx> crateApiWalletWalletBuildPayjoinTx(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        var arg6 = cst_encode_opt_box_autoadd_u_32(deductFee);
      ...
      argValues: [that, sats, outAddress, asset, network, baseUrl, deductFee],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta get kCrateApiWalletWalletBuildPayjoinTxConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["that", "sats", "outAddress", "asset", "network", "baseUrl", "deductFee"],
      );
